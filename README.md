...
In the present repository one could find a few jupyter notebook and bash scripts for data analysis about COVID-19. There are two essential plots one could make:
